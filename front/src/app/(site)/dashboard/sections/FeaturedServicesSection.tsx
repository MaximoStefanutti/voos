  ...
  return (
    <section className="py-16 px-6 bg-[#0a3635]/30">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-4xl text-center font-light text-white mb-1">
          Tratamientos Destacados
        </h2>
        <p className="text-[#f0d4a8] text-center text-base md:text-lg max-w-xl mx-auto mb-8">
          Descubrí nuestros tratamientos faciales y corporales diseñados para
          realzar tu belleza y bienestar en Córdoba Capital
        </p>
