...
export const categoryContent: CategoryContent = {
    ...
    faqs: [
      {
        ...
        answer:
          "La cantidad de sesiones depende del tratamiento seleccionado y de la evaluación personalizada realizada en nuestro centro en Córdoba. En general, se recomienda entre 4 y 6 sesiones para lograr resultados visibles y sostenidos.",
      },
      {
  ...
  facial: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Nuestro centro de estética en Córdoba Capital está orientado al cuidado integral de la piel. Realizamos una evaluación previa para determinar el tipo de piel, nivel de hidratación, sensibilidad y necesidades específicas. A partir de ese diagnóstico diseñamos un plan de tratamiento personalizado que puede incluir limpieza facial profunda, hidratación intensiva, tratamientos para piel grasa o con tendencia acneica, protocolos para manchas y estimulación de colágeno. \n\nTrabajamos con aparatología estética profesional y productos de calidad que permiten potenciar los resultados respetando siempre la salud cutánea.",
      },
      {
        title: "Limpieza facial profunda en Córdoba Capital",
        content:
          "La limpieza facial profesional es uno de los tratamientos más solicitados en Córdoba. Permite eliminar impurezas, células muertas y exceso de sebo acumulado, favoreciendo la oxigenación de la piel. Este procedimiento ayuda a prevenir brotes de acné, mejora la textura y potencia la absorción de principios activos en tratamientos posteriores. Es ideal tanto para pieles jóvenes como para pieles adultas que buscan mantener un aspecto saludable.",
      },
      {
      ...
      },
      {
        ...
        content:
          "la hidratación profunda es clave para mantener la elasticidad y firmeza de la piel. Nuestros tratamientos faciales incluyen protocolos que estimulan la producción natural de colágeno y elastina, ayudando a reducir el envejecimiento y signos de fatiga.\n\nEstos procedimientos están pensados para quienes buscan rejuvenecer la piel sin recurrir a métodos invasivos, logrando resultados progresivos, armónicos y naturales.",
      },
      {
        title: "Tratamientos personalizados según tipo de piel",
        content:
          "Elegir un centro de estética facial en Córdoba implica confiar en profesionales capacitados y protocolos seguros. En VOOS Estética priorizamos la atención personalizada, la higiene estricta y el uso de tecnología adecuada para cada necesidad.\n\nNuestro objetivo es mejorar la calidad de la piel de forma progresiva, natural y segura, ofreciendo un espacio cómodo y preparado para brindar una experiencia relajante y profesional.",
      },
    ],
    ...
    faqs: [
      {
        question: "¿Cada cuánto se recomienda realizar una limpieza facial?",
        answer:
          "En general, se recomienda realizar una limpieza facial profesional cada 30 a 45 días, dependiendo del tipo de piel y sus necesidades específicas. En Córdoba muchas personas la incorporan como parte de su rutina mensual de cuidado.",
      },
      {
        question:
      ...
      },
      {
        ...
        answer:
          "No. La mayoría de los procedimientos son confortables y están diseñados para brindar una experiencia relajante. Algunas extracciones pueden generar leve molestia, pero siempre se realizan con técnicas seguras.",
      },
      {
        question: "¿Cuándo se comienzan a ver resultados?",
        answer:
          "Muchos pacientes notan mejoras inmediatas en luminosidad e hidratación. Los tratamientos orientados a firmeza o manchas requieren sesiones progresivas para resultados más notorios.",
      },
      {
        question:
          "¿Realizan tratamientos faciales en Córdoba Capital todo el año?",
        answer:
          "Si, trabajamos durante todo el año adaptando los protocolos según la estación y las necesidades de la piel en cada momento.",
      },
    ],
  },
  ...
  masajes: {
    ...
    heroImage: "/image/tratamientos/maderoterapia.webp",

    intro:
      "En VOOS Estética ofrecemos masajes en Córdoba Capital orientados al bienestar físico y mental. Nuestros protocolos combinan técnicas manuales específicas con un ambiente preparado para brindar relajación profunda, alivio muscular y equilibrio corporal.",
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "El masaje relajante está orientado a disminuir el estrés físico y mental. Utilizamos movimientos suaves y rítmicos que inducen a un estado de relajación profunda, ayudando a regular el sistema nervioso y mejorar la calidad del descanso.\n\nEn Córdoba Capital muchas personas incorporan este tipo de masaje como parte de su rutina mensual de bienestar, ya que contribuye a reducir la ansiedad y mejorar la sensación general de equilibrio.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Los masajes profesionales no solo generan relajación inmediata, sino que aportan múltiples beneficios a corto y largo plazo. Mejoran la circulación sanguínea, estimulan el drenaje linfático, disminuyen la tensión muscular y favorecen la liberación de endorfinas.\n\nRealizar sesiones periódicas en un centro especializado puede ayudar a prevenir contracturas recurrentes y mejorar la calidad de vida.",
      },
      {
    ...
    benefits: [
      ...
      "Disminución de tensiones acumuladas",
      "Bienestar físico y mental integral",
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Puede generar una leve molestia al trabajar sobre zonas contracturadas, pero siempre se adapta la intensidad según la tolerancia de cada persona para garantizar comodidad y seguridad.",
      },
      {
        question: "¿Cada cuánto se recomienda realizar masajes?",
        answer:
          "Para mantenimiento general se recomienda una sesión cada 15 o 30 días. En casos de contracturas frecuentes puede indicarse mayor periodicidad según evaluación profesional.",
      },
      {
  ...
  depilacion: {
    ...
    heroImage: "/image/tratamientos/depilacion.webp",

    intro:
      "En VOOS Estética ofrecemos servicio de depilación en Córdoba Capital con técnicas adaptadas a cada tipo de piel. Priorizamos la higiene, la seguridad y la comodidad para lograr resultados efectivos y duraderos en un entorno profesional.",
    ...
    benefits: [
      "Resultados más duraderos que métodos caseros",
      "Menor riesgo de irritación y reacciones adversas",
      "Protocolos higiénicos estrictos",
      "Atención personalizada según tipo de piel",
      "Piel más suave y uniforme",
      "Reducción progresiva del vello con sesiones periódicas",
    ],

    faqs: [
      {
        question: "¿Cada cuánto se recomienda realizar depilación?",
        answer:
          "La frecuencia depende del crecimiento del vello de cada persona, pero generalmente se recomienda cada 3 a 5 semanas para mantener resultados óptimos.",
      },
      {
  ...
  "terapia-energetica": {
    ...
    intro:
      "En VOOS Estética ofrecemos terapias energéticas en Córdoba Capital orientadas al bienestar integral, la armonización emocional y la reducción del estrés cotidiano. Nuestras sesiones están diseñadas para brindar un espacio de calma, conexión y equilibrio.",
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Las sesiones de terapia energética pueden favorecer la disminución del estrés, mejorar la calidad del descanso y promover una sensación general de calma. Muchas personas experimentan mayor liviandad emocional y equilibrio luego de cada encuentro. La práctica regular puede contribuir a sostener ese bienestar en el tiempo como complemento de otros hábitos saludables.",
      },
      {
        title: "Reducción del estrés y conexión interior",
        content:
          "En el contexto actual, el estrés es una de las principales causas de malestar cotidiano. Las terapias energéticas ofrecen un momento de pausa consciente que ayuda a regular el sistema nervioso y disminuir la sobrecarga emocional. La experiencia se centra en la relajación profunda, la respiración consciente y la armonización del cuerpo.",
      },
      {
        title: "Un enfoque complementario de bienestar en Córdoba",
        content:
          "Las terapias energéticas forman parte de un enfoque integral del bienestar. En VOOS Estética trabajamos desde una mirada complementaria, acompañando procesos personales sin reemplazar tratamientos médicos ni psicológicos.\n\nNuestro objetivo es ofrecer un espacio de contención y equilibrio para quienes buscan mejorar su bienestar emocional en Córdoba Capital.",
      },
      {
        title: "¿Por qué elegir nuestras terapias energéticas?",
        content:
          "Elegir un espacio profesional en Córdoba Capital garantiza un entorno cuidado, confidencial y preparado para la relajación. En VOOS Estética priorizamos la escucha activa, la atención personalizada y el respeto por cada proceso individual. Cada sesión es única y se adapta al momento personal de quien asiste.",
      },
    ],
    ...
    benefits: [
      ...
      "Relajación profunda",
      "Espacio de desconexión consciente",
      "Enfoque complementario de bienestar",
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "La frecuencia depende de cada persona. Algunas eligen sesiones ocasionales para relajación, mientras otras prefieren encuentros periódicos para sostener el equilibrio.",
      },
      {
        question:
